...
public class Komutlar {
       ...
       public void yaziYazXpath(String elementId,String yaziId){
        driver.findElement(By.xpath(elementId)).sendKeys(yaziId,Keys.ENTER);
        ...
        public void metinKontrolCss(String bulunanId,String aratılanId){
        ...
        public void gorunurlukBekleCss (String elementId){
        ...
        public void gorunurlukBekleXpath (String elementId){
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(25L));
        ...
        public void urlKarsilatir (String beklenenUrl){
